...
<table>
    ...
    <div style="display:flex;">
     <a href="AddProjects" class="add-btn">
                     Add Project
                    </a>
                     <a href="/" class="add-btn" style="margin-left:10px">GO to index</a>
                         </div>
        <%
            List<Projects> employeeList = (List<Projects>) request.getAttribute("projects");
        ...
        <tr>
            ...
            <td><%= employee.getSubmitionDate() %></td>
             ...
             <input type="submit" value="View Employee" class="btn-edit">
             </form>
